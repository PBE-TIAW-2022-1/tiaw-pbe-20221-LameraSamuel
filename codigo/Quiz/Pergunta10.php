	...
	<body>
		...
		<div class="tela-login">
				...
				<form>
					...
					?>
					<a href="Resultadoquiz.php"><input type="button" value=<?=$buscando["Descricao"]?> class="enviar"></input></a>
				</form>
				<?php } ?>
				...
				<p class="alert-success"><a href="Pergunta9.php"><input type="button" value="Pergunta Anterior" class="enviar"></input></a>
